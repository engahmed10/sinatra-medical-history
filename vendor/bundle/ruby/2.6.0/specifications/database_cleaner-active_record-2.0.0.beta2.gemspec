# -*- encoding: utf-8 -*-
# stub: database_cleaner-active_record 2.0.0.beta2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<database_cleaner-core>.freeze, ["~> 2.0.0.beta2"])
    ...
    s.add_dependency(%q<database_cleaner-core>.freeze, ["~> 2.0.0.beta2"])
